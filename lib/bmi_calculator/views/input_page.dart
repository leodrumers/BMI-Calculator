import 'package:bmi_calculator/bmi_calculator/model/calculator_brain.dart';
import 'package:bmi_calculator/bmi_calculator/views/result_page.dart';
import 'package:bmi_calculator/bmi_calculator/widgets/round_button.dart';
...
GlobalKey<ScaffoldState> _bmiKey = GlobalKey();
...
class _InputPageState extends State<InputPage> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      onWillPop: () {
        if (_bmiKey.currentState.isDrawerOpen) {
